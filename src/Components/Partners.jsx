...
export default function Partners() {
  return (
   <div style={{marginTop:'6rem',display:'flex',justifyContent:'center',flexDirection:'column',alignItems:'center'}}>
    ...
    <img src={apollotransperant} alt="" style={{width:'10%'}} />
    <img src={lilavathitransperant} alt="" style={{width:'15%'}} />
    <img src={fortisransperant} alt="" style={{width:'15%'}} />
    <img src={medantatransperant} alt="" style={{width:'15%'}} />
    <img src={meenakshitransperant} alt="" style={{width:'15%'}} />
